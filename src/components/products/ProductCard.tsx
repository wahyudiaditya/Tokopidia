...
export default function ProductCard({
  ...
  const handleAddtoWishlist = async (productId: ObjectId) => {
    const result = await fetch(`${BASE_URL}/api/wishlist`, {
      method: "POST",
      headers: {
  ...
  return (
    <div>
      <div className=" rounded-md shadow-md bg-white w-[200px] h-[322px]">
        ...
        <div className="px-2 pt-2 text-xs">
          ...
          <div className="flex text-sm gap-2 py-2 pt-3">
            ...
            <button
              className="flex items-center gap-1 border-x px-2"
